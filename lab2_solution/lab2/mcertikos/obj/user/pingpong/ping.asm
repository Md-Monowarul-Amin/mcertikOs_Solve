...
40000c08:	6a 64                	push   $0x64
40000c0a:	8d 83 c8 e1 ff ff    	lea    -0x1e38(%ebx),%eax
40000c10:	50                   	push   %eax
40000c11:	e8 d6 f5 ff ff       	call   400001ec <printf>
    *addr = val;
40000c16:	c7 05 00 00 00 e0 64 	movl   $0x64,0xe0000000
40000c1d:	00 00 00 
    yield();
40000c20:	e8 be fb ff ff       	call   400007e3 <yield>
    printf("ping: the new value at address %x: %d\n", addr, *addr);
40000c25:	83 c4 0c             	add    $0xc,%esp
40000c28:	ff 35 00 00 00 e0    	push   0xe0000000
40000c2e:	68 00 00 00 e0       	push   $0xe0000000
40000c33:	8d 83 f8 e1 ff ff    	lea    -0x1e08(%ebx),%eax
40000c39:	50                   	push   %eax
40000c3a:	e8 ad f5 ff ff       	call   400001ec <printf>

    return 0;
}
40000c3f:	83 c4 10             	add    $0x10,%esp
40000c42:	b8 00 00 00 00       	mov    $0x0,%eax
40000c47:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c4a:	59                   	pop    %ecx
40000c4b:	5b                   	pop    %ebx
40000c4c:	5d                   	pop    %ebp
40000c4d:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c50:	c3                   	ret    
40000c51:	66 90                	xchg   %ax,%ax
