...
4000026f:	e8 3c 0a 00 00       	call   40000cb0 <__udivdi3>
...
400002ac:	e8 1f 0b 00 00       	call   40000dd0 <__umoddi3>
...
40000be6:	83 c4 08             	add    $0x8,%esp
40000be9:	68 e8 03 00 00       	push   $0x3e8
40000bee:	6a 01                	push   $0x1
40000bf0:	e8 cf fb ff ff       	call   400007c4 <spawn>
40000bf5:	83 c4 10             	add    $0x10,%esp
40000bf8:	83 f8 ff             	cmp    $0xffffffff,%eax
40000bfb:	74 76                	je     40000c73 <main+0xb6>
        printf("ping in process %d.\n", ping_pid);
40000bfd:	83 ec 08             	sub    $0x8,%esp
40000c00:	50                   	push   %eax
40000c01:	8d 83 9a e1 ff ff    	lea    -0x1e66(%ebx),%eax
40000c07:	50                   	push   %eax
40000c08:	e8 df f5 ff ff       	call   400001ec <printf>
40000c0d:	83 c4 10             	add    $0x10,%esp
    else
        printf("Failed to launch ping.\n");

    if ((pong_pid = spawn(2, 1000)) != -1)
40000c10:	83 ec 08             	sub    $0x8,%esp
40000c13:	68 e8 03 00 00       	push   $0x3e8
40000c18:	6a 02                	push   $0x2
40000c1a:	e8 a5 fb ff ff       	call   400007c4 <spawn>
40000c1f:	83 c4 10             	add    $0x10,%esp
40000c22:	83 f8 ff             	cmp    $0xffffffff,%eax
40000c25:	74 60                	je     40000c87 <main+0xca>
        printf("pong in process %d.\n", pong_pid);
40000c27:	83 ec 08             	sub    $0x8,%esp
40000c2a:	50                   	push   %eax
40000c2b:	8d 83 c7 e1 ff ff    	lea    -0x1e39(%ebx),%eax
40000c31:	50                   	push   %eax
40000c32:	e8 b5 f5 ff ff       	call   400001ec <printf>
40000c37:	83 c4 10             	add    $0x10,%esp
    else
        printf("Failed to launch pong.\n");

    if ((ding_pid = spawn(3, 1000)) != -1)
40000c3a:	83 ec 08             	sub    $0x8,%esp
40000c3d:	68 e8 03 00 00       	push   $0x3e8
40000c42:	6a 03                	push   $0x3
40000c44:	e8 7b fb ff ff       	call   400007c4 <spawn>
40000c49:	83 c4 10             	add    $0x10,%esp
40000c4c:	83 f8 ff             	cmp    $0xffffffff,%eax
40000c4f:	74 4a                	je     40000c9b <main+0xde>
        printf("ding in process %d.\n", ding_pid);
40000c51:	83 ec 08             	sub    $0x8,%esp
40000c54:	50                   	push   %eax
40000c55:	8d 83 f4 e1 ff ff    	lea    -0x1e0c(%ebx),%eax
40000c5b:	50                   	push   %eax
40000c5c:	e8 8b f5 ff ff       	call   400001ec <printf>
...
40000c64:	b8 00 00 00 00       	mov    $0x0,%eax
40000c69:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c6c:	59                   	pop    %ecx
40000c6d:	5b                   	pop    %ebx
40000c6e:	5d                   	pop    %ebp
40000c6f:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c72:	c3                   	ret    
        printf("Failed to launch ping.\n");
40000c73:	83 ec 0c             	sub    $0xc,%esp
40000c76:	8d 83 af e1 ff ff    	lea    -0x1e51(%ebx),%eax
40000c7c:	50                   	push   %eax
40000c7d:	e8 6a f5 ff ff       	call   400001ec <printf>
40000c82:	83 c4 10             	add    $0x10,%esp
40000c85:	eb 89                	jmp    40000c10 <main+0x53>
        printf("Failed to launch pong.\n");
40000c87:	83 ec 0c             	sub    $0xc,%esp
40000c8a:	8d 83 dc e1 ff ff    	lea    -0x1e24(%ebx),%eax
40000c90:	50                   	push   %eax
40000c91:	e8 56 f5 ff ff       	call   400001ec <printf>
40000c96:	83 c4 10             	add    $0x10,%esp
40000c99:	eb 9f                	jmp    40000c3a <main+0x7d>
        printf("Failed to launch ding.\n");
40000c9b:	83 ec 0c             	sub    $0xc,%esp
40000c9e:	8d 83 09 e2 ff ff    	lea    -0x1df7(%ebx),%eax
40000ca4:	50                   	push   %eax
40000ca5:	e8 42 f5 ff ff       	call   400001ec <printf>
40000caa:	83 c4 10             	add    $0x10,%esp
40000cad:	eb b5                	jmp    40000c64 <main+0xa7>
40000caf:	90                   	nop

40000cb0 <__udivdi3>:
40000cb0:	f3 0f 1e fb          	endbr32 
40000cb4:	55                   	push   %ebp
40000cb5:	57                   	push   %edi
40000cb6:	56                   	push   %esi
40000cb7:	53                   	push   %ebx
40000cb8:	83 ec 1c             	sub    $0x1c,%esp
40000cbb:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000cbf:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000cc3:	8b 74 24 34          	mov    0x34(%esp),%esi
40000cc7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000ccb:	85 c0                	test   %eax,%eax
40000ccd:	75 19                	jne    40000ce8 <__udivdi3+0x38>
40000ccf:	39 f3                	cmp    %esi,%ebx
40000cd1:	76 4d                	jbe    40000d20 <__udivdi3+0x70>
40000cd3:	31 ff                	xor    %edi,%edi
40000cd5:	89 e8                	mov    %ebp,%eax
40000cd7:	89 f2                	mov    %esi,%edx
40000cd9:	f7 f3                	div    %ebx
40000cdb:	89 fa                	mov    %edi,%edx
40000cdd:	83 c4 1c             	add    $0x1c,%esp
40000ce0:	5b                   	pop    %ebx
40000ce1:	5e                   	pop    %esi
40000ce2:	5f                   	pop    %edi
40000ce3:	5d                   	pop    %ebp
...
40000ce8:	39 f0                	cmp    %esi,%eax
40000cea:	76 14                	jbe    40000d00 <__udivdi3+0x50>
40000cec:	31 ff                	xor    %edi,%edi
40000cee:	31 c0                	xor    %eax,%eax
40000cf0:	89 fa                	mov    %edi,%edx
40000cf2:	83 c4 1c             	add    $0x1c,%esp
40000cf5:	5b                   	pop    %ebx
40000cf6:	5e                   	pop    %esi
40000cf7:	5f                   	pop    %edi
40000cf8:	5d                   	pop    %ebp
...
40000d00:	0f bd f8             	bsr    %eax,%edi
40000d03:	83 f7 1f             	xor    $0x1f,%edi
40000d06:	75 48                	jne    40000d50 <__udivdi3+0xa0>
40000d08:	39 f0                	cmp    %esi,%eax
40000d0a:	72 06                	jb     40000d12 <__udivdi3+0x62>
40000d0c:	31 c0                	xor    %eax,%eax
40000d0e:	39 eb                	cmp    %ebp,%ebx
40000d10:	77 de                	ja     40000cf0 <__udivdi3+0x40>
40000d12:	b8 01 00 00 00       	mov    $0x1,%eax
40000d17:	eb d7                	jmp    40000cf0 <__udivdi3+0x40>
40000d19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000d20:	89 d9                	mov    %ebx,%ecx
40000d22:	85 db                	test   %ebx,%ebx
40000d24:	75 0b                	jne    40000d31 <__udivdi3+0x81>
40000d26:	b8 01 00 00 00       	mov    $0x1,%eax
40000d2b:	31 d2                	xor    %edx,%edx
40000d2d:	f7 f3                	div    %ebx
40000d2f:	89 c1                	mov    %eax,%ecx
40000d31:	31 d2                	xor    %edx,%edx
40000d33:	89 f0                	mov    %esi,%eax
40000d35:	f7 f1                	div    %ecx
40000d37:	89 c6                	mov    %eax,%esi
40000d39:	89 e8                	mov    %ebp,%eax
40000d3b:	89 f7                	mov    %esi,%edi
40000d3d:	f7 f1                	div    %ecx
40000d3f:	89 fa                	mov    %edi,%edx
40000d41:	83 c4 1c             	add    $0x1c,%esp
40000d44:	5b                   	pop    %ebx
40000d45:	5e                   	pop    %esi
40000d46:	5f                   	pop    %edi
40000d47:	5d                   	pop    %ebp
...
40000d50:	89 f9                	mov    %edi,%ecx
40000d52:	ba 20 00 00 00       	mov    $0x20,%edx
40000d57:	29 fa                	sub    %edi,%edx
40000d59:	d3 e0                	shl    %cl,%eax
40000d5b:	89 44 24 08          	mov    %eax,0x8(%esp)
40000d5f:	89 d1                	mov    %edx,%ecx
40000d61:	89 d8                	mov    %ebx,%eax
40000d63:	d3 e8                	shr    %cl,%eax
40000d65:	8b 4c 24 08          	mov    0x8(%esp),%ecx
40000d69:	09 c1                	or     %eax,%ecx
40000d6b:	89 f0                	mov    %esi,%eax
40000d6d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000d71:	89 f9                	mov    %edi,%ecx
40000d73:	d3 e3                	shl    %cl,%ebx
40000d75:	89 d1                	mov    %edx,%ecx
40000d77:	d3 e8                	shr    %cl,%eax
40000d79:	89 f9                	mov    %edi,%ecx
40000d7b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
40000d7f:	89 eb                	mov    %ebp,%ebx
40000d81:	d3 e6                	shl    %cl,%esi
40000d83:	89 d1                	mov    %edx,%ecx
40000d85:	d3 eb                	shr    %cl,%ebx
40000d87:	09 f3                	or     %esi,%ebx
40000d89:	89 c6                	mov    %eax,%esi
40000d8b:	89 f2                	mov    %esi,%edx
40000d8d:	89 d8                	mov    %ebx,%eax
40000d8f:	f7 74 24 08          	divl   0x8(%esp)
40000d93:	89 d6                	mov    %edx,%esi
40000d95:	89 c3                	mov    %eax,%ebx
40000d97:	f7 64 24 0c          	mull   0xc(%esp)
40000d9b:	39 d6                	cmp    %edx,%esi
40000d9d:	72 19                	jb     40000db8 <__udivdi3+0x108>
40000d9f:	89 f9                	mov    %edi,%ecx
40000da1:	d3 e5                	shl    %cl,%ebp
40000da3:	39 c5                	cmp    %eax,%ebp
40000da5:	73 04                	jae    40000dab <__udivdi3+0xfb>
40000da7:	39 d6                	cmp    %edx,%esi
40000da9:	74 0d                	je     40000db8 <__udivdi3+0x108>
40000dab:	89 d8                	mov    %ebx,%eax
40000dad:	31 ff                	xor    %edi,%edi
40000daf:	e9 3c ff ff ff       	jmp    40000cf0 <__udivdi3+0x40>
40000db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000db8:	8d 43 ff             	lea    -0x1(%ebx),%eax
40000dbb:	31 ff                	xor    %edi,%edi
40000dbd:	e9 2e ff ff ff       	jmp    40000cf0 <__udivdi3+0x40>
40000dc2:	66 90                	xchg   %ax,%ax
40000dc4:	66 90                	xchg   %ax,%ax
40000dc6:	66 90                	xchg   %ax,%ax
40000dc8:	66 90                	xchg   %ax,%ax
40000dca:	66 90                	xchg   %ax,%ax
40000dcc:	66 90                	xchg   %ax,%ax
40000dce:	66 90                	xchg   %ax,%ax

40000dd0 <__umoddi3>:
40000dd0:	f3 0f 1e fb          	endbr32 
40000dd4:	55                   	push   %ebp
40000dd5:	57                   	push   %edi
40000dd6:	56                   	push   %esi
40000dd7:	53                   	push   %ebx
40000dd8:	83 ec 1c             	sub    $0x1c,%esp
40000ddb:	8b 74 24 30          	mov    0x30(%esp),%esi
40000ddf:	8b 5c 24 34          	mov    0x34(%esp),%ebx
40000de3:	8b 7c 24 3c          	mov    0x3c(%esp),%edi
40000de7:	8b 6c 24 38          	mov    0x38(%esp),%ebp
40000deb:	89 f0                	mov    %esi,%eax
40000ded:	89 da                	mov    %ebx,%edx
40000def:	85 ff                	test   %edi,%edi
40000df1:	75 15                	jne    40000e08 <__umoddi3+0x38>
40000df3:	39 dd                	cmp    %ebx,%ebp
40000df5:	76 39                	jbe    40000e30 <__umoddi3+0x60>
40000df7:	f7 f5                	div    %ebp
40000df9:	89 d0                	mov    %edx,%eax
40000dfb:	31 d2                	xor    %edx,%edx
40000dfd:	83 c4 1c             	add    $0x1c,%esp
40000e00:	5b                   	pop    %ebx
40000e01:	5e                   	pop    %esi
40000e02:	5f                   	pop    %edi
40000e03:	5d                   	pop    %ebp
40000e04:	c3                   	ret    
40000e05:	8d 76 00             	lea    0x0(%esi),%esi
40000e08:	39 df                	cmp    %ebx,%edi
40000e0a:	77 f1                	ja     40000dfd <__umoddi3+0x2d>
40000e0c:	0f bd cf             	bsr    %edi,%ecx
40000e0f:	83 f1 1f             	xor    $0x1f,%ecx
40000e12:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000e16:	75 40                	jne    40000e58 <__umoddi3+0x88>
40000e18:	39 df                	cmp    %ebx,%edi
40000e1a:	72 04                	jb     40000e20 <__umoddi3+0x50>
40000e1c:	39 f5                	cmp    %esi,%ebp
40000e1e:	77 dd                	ja     40000dfd <__umoddi3+0x2d>
40000e20:	89 da                	mov    %ebx,%edx
40000e22:	89 f0                	mov    %esi,%eax
40000e24:	29 e8                	sub    %ebp,%eax
40000e26:	19 fa                	sbb    %edi,%edx
40000e28:	eb d3                	jmp    40000dfd <__umoddi3+0x2d>
40000e2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000e30:	89 e9                	mov    %ebp,%ecx
40000e32:	85 ed                	test   %ebp,%ebp
40000e34:	75 0b                	jne    40000e41 <__umoddi3+0x71>
40000e36:	b8 01 00 00 00       	mov    $0x1,%eax
40000e3b:	31 d2                	xor    %edx,%edx
40000e3d:	f7 f5                	div    %ebp
40000e3f:	89 c1                	mov    %eax,%ecx
40000e41:	89 d8                	mov    %ebx,%eax
40000e43:	31 d2                	xor    %edx,%edx
40000e45:	f7 f1                	div    %ecx
40000e47:	89 f0                	mov    %esi,%eax
40000e49:	f7 f1                	div    %ecx
40000e4b:	89 d0                	mov    %edx,%eax
40000e4d:	31 d2                	xor    %edx,%edx
40000e4f:	eb ac                	jmp    40000dfd <__umoddi3+0x2d>
40000e51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000e58:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e5c:	ba 20 00 00 00       	mov    $0x20,%edx
40000e61:	29 c2                	sub    %eax,%edx
40000e63:	89 c1                	mov    %eax,%ecx
40000e65:	89 e8                	mov    %ebp,%eax
40000e67:	d3 e7                	shl    %cl,%edi
40000e69:	89 d1                	mov    %edx,%ecx
40000e6b:	89 54 24 0c          	mov    %edx,0xc(%esp)
40000e6f:	d3 e8                	shr    %cl,%eax
40000e71:	89 c1                	mov    %eax,%ecx
40000e73:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e77:	09 f9                	or     %edi,%ecx
40000e79:	89 df                	mov    %ebx,%edi
40000e7b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e7f:	89 c1                	mov    %eax,%ecx
40000e81:	d3 e5                	shl    %cl,%ebp
40000e83:	89 d1                	mov    %edx,%ecx
40000e85:	d3 ef                	shr    %cl,%edi
40000e87:	89 c1                	mov    %eax,%ecx
40000e89:	89 f0                	mov    %esi,%eax
40000e8b:	d3 e3                	shl    %cl,%ebx
40000e8d:	89 d1                	mov    %edx,%ecx
40000e8f:	89 fa                	mov    %edi,%edx
40000e91:	d3 e8                	shr    %cl,%eax
40000e93:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000e98:	09 d8                	or     %ebx,%eax
40000e9a:	f7 74 24 08          	divl   0x8(%esp)
40000e9e:	89 d3                	mov    %edx,%ebx
40000ea0:	d3 e6                	shl    %cl,%esi
40000ea2:	f7 e5                	mul    %ebp
40000ea4:	89 c7                	mov    %eax,%edi
40000ea6:	89 d1                	mov    %edx,%ecx
40000ea8:	39 d3                	cmp    %edx,%ebx
40000eaa:	72 06                	jb     40000eb2 <__umoddi3+0xe2>
40000eac:	75 0e                	jne    40000ebc <__umoddi3+0xec>
40000eae:	39 c6                	cmp    %eax,%esi
40000eb0:	73 0a                	jae    40000ebc <__umoddi3+0xec>
40000eb2:	29 e8                	sub    %ebp,%eax
40000eb4:	1b 54 24 08          	sbb    0x8(%esp),%edx
40000eb8:	89 d1                	mov    %edx,%ecx
40000eba:	89 c7                	mov    %eax,%edi
40000ebc:	89 f5                	mov    %esi,%ebp
40000ebe:	8b 74 24 04          	mov    0x4(%esp),%esi
40000ec2:	29 fd                	sub    %edi,%ebp
40000ec4:	19 cb                	sbb    %ecx,%ebx
40000ec6:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
40000ecb:	89 d8                	mov    %ebx,%eax
40000ecd:	d3 e0                	shl    %cl,%eax
40000ecf:	89 f1                	mov    %esi,%ecx
40000ed1:	d3 ed                	shr    %cl,%ebp
40000ed3:	d3 eb                	shr    %cl,%ebx
40000ed5:	09 e8                	or     %ebp,%eax
40000ed7:	89 da                	mov    %ebx,%edx
40000ed9:	83 c4 1c             	add    $0x1c,%esp
40000edc:	5b                   	pop    %ebx
40000edd:	5e                   	pop    %esi
40000ede:	5f                   	pop    %edi
40000edf:	5d                   	pop    %ebp
