...
obj/user/fork_test/fork_test:     file format elf32-i386
...
4000026f:	e8 0c 0a 00 00       	call   40000c80 <__udivdi3>
...
400002ac:	e8 ef 0a 00 00       	call   40000da0 <__umoddi3>
...
40000bca:	56                   	push   %esi
40000bcb:	53                   	push   %ebx
40000bcc:	51                   	push   %ecx
40000bcd:	83 ec 0c             	sub    $0xc,%esp
40000bd0:	e8 9e 00 00 00       	call   40000c73 <__x86.get_pc_thunk.si>
40000bd5:	81 c6 2b 24 00 00    	add    $0x242b,%esi
static gcc_inline pid_t sys_fork(void)
{
    ...
    asm volatile ("int %2"
40000bdb:	b8 03 00 00 00       	mov    $0x3,%eax
40000be0:	cd 30                	int    $0x30
    pid_t pid;
...
40000be4:	75 52                	jne    40000c38 <main+0x7b>
40000be6:	b8 03 00 00 00       	mov    $0x3,%eax
40000beb:	cd 30                	int    $0x30
        pid = sys_fork();

        if (pid == 0) {
40000bed:	85 db                	test   %ebx,%ebx
40000bef:	75 2a                	jne    40000c1b <main+0x5e>
            printf("This is grandchild, global = %p\n", global_test);
40000bf1:	83 ec 08             	sub    $0x8,%esp
40000bf4:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000bfa:	8d 86 94 e1 ff ff    	lea    -0x1e6c(%esi),%eax
40000c00:	50                   	push   %eax
40000c01:	89 f3                	mov    %esi,%ebx
40000c03:	e8 e4 f5 ff ff       	call   400001ec <printf>
40000c08:	83 c4 10             	add    $0x10,%esp
        global_test = 0x5678;
...
40000c0b:	b8 00 00 00 00       	mov    $0x0,%eax
40000c10:	8d 65 f4             	lea    -0xc(%ebp),%esp
40000c13:	59                   	pop    %ecx
40000c14:	5b                   	pop    %ebx
40000c15:	5e                   	pop    %esi
40000c16:	5d                   	pop    %ebp
40000c17:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c1a:	c3                   	ret    
            printf("Child forks %d, global = %p\n", pid, global_test);
40000c1b:	83 ec 04             	sub    $0x4,%esp
40000c1e:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000c24:	53                   	push   %ebx
40000c25:	8d 86 b5 e1 ff ff    	lea    -0x1e4b(%esi),%eax
40000c2b:	50                   	push   %eax
40000c2c:	89 f3                	mov    %esi,%ebx
40000c2e:	e8 b9 f5 ff ff       	call   400001ec <printf>
40000c33:	83 c4 10             	add    $0x10,%esp
40000c36:	eb d3                	jmp    40000c0b <main+0x4e>
        printf("parent forks %d, global = %p\n", pid, global_test);
40000c38:	83 ec 04             	sub    $0x4,%esp
40000c3b:	ff b6 0c 00 00 00    	push   0xc(%esi)
40000c41:	53                   	push   %ebx
40000c42:	8d 86 d2 e1 ff ff    	lea    -0x1e2e(%esi),%eax
40000c48:	50                   	push   %eax
40000c49:	89 f3                	mov    %esi,%ebx
40000c4b:	e8 9c f5 ff ff       	call   400001ec <printf>
        global_test = 0x5678;
40000c50:	c7 86 0c 00 00 00 78 	movl   $0x5678,0xc(%esi)
40000c57:	56 00 00 
        printf("parent global_test1 = %p\n", global_test);
40000c5a:	83 c4 08             	add    $0x8,%esp
40000c5d:	68 78 56 00 00       	push   $0x5678
40000c62:	8d 86 f0 e1 ff ff    	lea    -0x1e10(%esi),%eax
40000c68:	50                   	push   %eax
40000c69:	e8 7e f5 ff ff       	call   400001ec <printf>
40000c6e:	83 c4 10             	add    $0x10,%esp
40000c71:	eb 98                	jmp    40000c0b <main+0x4e>

40000c73 <__x86.get_pc_thunk.si>:
40000c73:	8b 34 24             	mov    (%esp),%esi
40000c76:	c3                   	ret    
40000c77:	66 90                	xchg   %ax,%ax
40000c79:	66 90                	xchg   %ax,%ax
40000c7b:	66 90                	xchg   %ax,%ax
40000c7d:	66 90                	xchg   %ax,%ax
40000c7f:	90                   	nop

40000c80 <__udivdi3>:
40000c80:	f3 0f 1e fb          	endbr32 
40000c84:	55                   	push   %ebp
40000c85:	57                   	push   %edi
40000c86:	56                   	push   %esi
40000c87:	53                   	push   %ebx
40000c88:	83 ec 1c             	sub    $0x1c,%esp
40000c8b:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000c8f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000c93:	8b 74 24 34          	mov    0x34(%esp),%esi
40000c97:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000c9b:	85 c0                	test   %eax,%eax
40000c9d:	75 19                	jne    40000cb8 <__udivdi3+0x38>
40000c9f:	39 f3                	cmp    %esi,%ebx
40000ca1:	76 4d                	jbe    40000cf0 <__udivdi3+0x70>
40000ca3:	31 ff                	xor    %edi,%edi
40000ca5:	89 e8                	mov    %ebp,%eax
40000ca7:	89 f2                	mov    %esi,%edx
40000ca9:	f7 f3                	div    %ebx
40000cab:	89 fa                	mov    %edi,%edx
40000cad:	83 c4 1c             	add    $0x1c,%esp
40000cb0:	5b                   	pop    %ebx
40000cb1:	5e                   	pop    %esi
40000cb2:	5f                   	pop    %edi
40000cb3:	5d                   	pop    %ebp
40000cb4:	c3                   	ret    
40000cb5:	8d 76 00             	lea    0x0(%esi),%esi
40000cb8:	39 f0                	cmp    %esi,%eax
40000cba:	76 14                	jbe    40000cd0 <__udivdi3+0x50>
40000cbc:	31 ff                	xor    %edi,%edi
40000cbe:	31 c0                	xor    %eax,%eax
40000cc0:	89 fa                	mov    %edi,%edx
40000cc2:	83 c4 1c             	add    $0x1c,%esp
40000cc5:	5b                   	pop    %ebx
40000cc6:	5e                   	pop    %esi
40000cc7:	5f                   	pop    %edi
40000cc8:	5d                   	pop    %ebp
...
40000cd0:	0f bd f8             	bsr    %eax,%edi
40000cd3:	83 f7 1f             	xor    $0x1f,%edi
40000cd6:	75 48                	jne    40000d20 <__udivdi3+0xa0>
40000cd8:	39 f0                	cmp    %esi,%eax
40000cda:	72 06                	jb     40000ce2 <__udivdi3+0x62>
40000cdc:	31 c0                	xor    %eax,%eax
40000cde:	39 eb                	cmp    %ebp,%ebx
40000ce0:	77 de                	ja     40000cc0 <__udivdi3+0x40>
40000ce2:	b8 01 00 00 00       	mov    $0x1,%eax
40000ce7:	eb d7                	jmp    40000cc0 <__udivdi3+0x40>
40000ce9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000cf0:	89 d9                	mov    %ebx,%ecx
40000cf2:	85 db                	test   %ebx,%ebx
40000cf4:	75 0b                	jne    40000d01 <__udivdi3+0x81>
40000cf6:	b8 01 00 00 00       	mov    $0x1,%eax
40000cfb:	31 d2                	xor    %edx,%edx
40000cfd:	f7 f3                	div    %ebx
40000cff:	89 c1                	mov    %eax,%ecx
40000d01:	31 d2                	xor    %edx,%edx
40000d03:	89 f0                	mov    %esi,%eax
40000d05:	f7 f1                	div    %ecx
40000d07:	89 c6                	mov    %eax,%esi
40000d09:	89 e8                	mov    %ebp,%eax
40000d0b:	89 f7                	mov    %esi,%edi
40000d0d:	f7 f1                	div    %ecx
40000d0f:	89 fa                	mov    %edi,%edx
40000d11:	83 c4 1c             	add    $0x1c,%esp
40000d14:	5b                   	pop    %ebx
40000d15:	5e                   	pop    %esi
40000d16:	5f                   	pop    %edi
40000d17:	5d                   	pop    %ebp
...
40000d20:	89 f9                	mov    %edi,%ecx
40000d22:	ba 20 00 00 00       	mov    $0x20,%edx
40000d27:	29 fa                	sub    %edi,%edx
40000d29:	d3 e0                	shl    %cl,%eax
40000d2b:	89 44 24 08          	mov    %eax,0x8(%esp)
40000d2f:	89 d1                	mov    %edx,%ecx
40000d31:	89 d8                	mov    %ebx,%eax
40000d33:	d3 e8                	shr    %cl,%eax
40000d35:	8b 4c 24 08          	mov    0x8(%esp),%ecx
40000d39:	09 c1                	or     %eax,%ecx
40000d3b:	89 f0                	mov    %esi,%eax
40000d3d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000d41:	89 f9                	mov    %edi,%ecx
40000d43:	d3 e3                	shl    %cl,%ebx
40000d45:	89 d1                	mov    %edx,%ecx
40000d47:	d3 e8                	shr    %cl,%eax
40000d49:	89 f9                	mov    %edi,%ecx
40000d4b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
40000d4f:	89 eb                	mov    %ebp,%ebx
40000d51:	d3 e6                	shl    %cl,%esi
40000d53:	89 d1                	mov    %edx,%ecx
40000d55:	d3 eb                	shr    %cl,%ebx
40000d57:	09 f3                	or     %esi,%ebx
40000d59:	89 c6                	mov    %eax,%esi
40000d5b:	89 f2                	mov    %esi,%edx
40000d5d:	89 d8                	mov    %ebx,%eax
40000d5f:	f7 74 24 08          	divl   0x8(%esp)
40000d63:	89 d6                	mov    %edx,%esi
40000d65:	89 c3                	mov    %eax,%ebx
40000d67:	f7 64 24 0c          	mull   0xc(%esp)
40000d6b:	39 d6                	cmp    %edx,%esi
40000d6d:	72 19                	jb     40000d88 <__udivdi3+0x108>
40000d6f:	89 f9                	mov    %edi,%ecx
40000d71:	d3 e5                	shl    %cl,%ebp
40000d73:	39 c5                	cmp    %eax,%ebp
40000d75:	73 04                	jae    40000d7b <__udivdi3+0xfb>
40000d77:	39 d6                	cmp    %edx,%esi
40000d79:	74 0d                	je     40000d88 <__udivdi3+0x108>
40000d7b:	89 d8                	mov    %ebx,%eax
40000d7d:	31 ff                	xor    %edi,%edi
40000d7f:	e9 3c ff ff ff       	jmp    40000cc0 <__udivdi3+0x40>
40000d84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
40000d88:	8d 43 ff             	lea    -0x1(%ebx),%eax
40000d8b:	31 ff                	xor    %edi,%edi
40000d8d:	e9 2e ff ff ff       	jmp    40000cc0 <__udivdi3+0x40>
40000d92:	66 90                	xchg   %ax,%ax
40000d94:	66 90                	xchg   %ax,%ax
40000d96:	66 90                	xchg   %ax,%ax
40000d98:	66 90                	xchg   %ax,%ax
40000d9a:	66 90                	xchg   %ax,%ax
40000d9c:	66 90                	xchg   %ax,%ax
40000d9e:	66 90                	xchg   %ax,%ax

40000da0 <__umoddi3>:
40000da0:	f3 0f 1e fb          	endbr32 
40000da4:	55                   	push   %ebp
40000da5:	57                   	push   %edi
40000da6:	56                   	push   %esi
40000da7:	53                   	push   %ebx
40000da8:	83 ec 1c             	sub    $0x1c,%esp
40000dab:	8b 74 24 30          	mov    0x30(%esp),%esi
40000daf:	8b 5c 24 34          	mov    0x34(%esp),%ebx
40000db3:	8b 7c 24 3c          	mov    0x3c(%esp),%edi
40000db7:	8b 6c 24 38          	mov    0x38(%esp),%ebp
40000dbb:	89 f0                	mov    %esi,%eax
40000dbd:	89 da                	mov    %ebx,%edx
40000dbf:	85 ff                	test   %edi,%edi
40000dc1:	75 15                	jne    40000dd8 <__umoddi3+0x38>
40000dc3:	39 dd                	cmp    %ebx,%ebp
40000dc5:	76 39                	jbe    40000e00 <__umoddi3+0x60>
40000dc7:	f7 f5                	div    %ebp
40000dc9:	89 d0                	mov    %edx,%eax
40000dcb:	31 d2                	xor    %edx,%edx
40000dcd:	83 c4 1c             	add    $0x1c,%esp
40000dd0:	5b                   	pop    %ebx
40000dd1:	5e                   	pop    %esi
40000dd2:	5f                   	pop    %edi
40000dd3:	5d                   	pop    %ebp
40000dd4:	c3                   	ret    
40000dd5:	8d 76 00             	lea    0x0(%esi),%esi
40000dd8:	39 df                	cmp    %ebx,%edi
40000dda:	77 f1                	ja     40000dcd <__umoddi3+0x2d>
40000ddc:	0f bd cf             	bsr    %edi,%ecx
40000ddf:	83 f1 1f             	xor    $0x1f,%ecx
40000de2:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000de6:	75 40                	jne    40000e28 <__umoddi3+0x88>
40000de8:	39 df                	cmp    %ebx,%edi
40000dea:	72 04                	jb     40000df0 <__umoddi3+0x50>
40000dec:	39 f5                	cmp    %esi,%ebp
40000dee:	77 dd                	ja     40000dcd <__umoddi3+0x2d>
40000df0:	89 da                	mov    %ebx,%edx
40000df2:	89 f0                	mov    %esi,%eax
40000df4:	29 e8                	sub    %ebp,%eax
40000df6:	19 fa                	sbb    %edi,%edx
40000df8:	eb d3                	jmp    40000dcd <__umoddi3+0x2d>
40000dfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
40000e00:	89 e9                	mov    %ebp,%ecx
40000e02:	85 ed                	test   %ebp,%ebp
40000e04:	75 0b                	jne    40000e11 <__umoddi3+0x71>
40000e06:	b8 01 00 00 00       	mov    $0x1,%eax
40000e0b:	31 d2                	xor    %edx,%edx
40000e0d:	f7 f5                	div    %ebp
40000e0f:	89 c1                	mov    %eax,%ecx
40000e11:	89 d8                	mov    %ebx,%eax
40000e13:	31 d2                	xor    %edx,%edx
40000e15:	f7 f1                	div    %ecx
40000e17:	89 f0                	mov    %esi,%eax
40000e19:	f7 f1                	div    %ecx
40000e1b:	89 d0                	mov    %edx,%eax
40000e1d:	31 d2                	xor    %edx,%edx
40000e1f:	eb ac                	jmp    40000dcd <__umoddi3+0x2d>
40000e21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000e28:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e2c:	ba 20 00 00 00       	mov    $0x20,%edx
40000e31:	29 c2                	sub    %eax,%edx
40000e33:	89 c1                	mov    %eax,%ecx
40000e35:	89 e8                	mov    %ebp,%eax
40000e37:	d3 e7                	shl    %cl,%edi
40000e39:	89 d1                	mov    %edx,%ecx
40000e3b:	89 54 24 0c          	mov    %edx,0xc(%esp)
40000e3f:	d3 e8                	shr    %cl,%eax
40000e41:	89 c1                	mov    %eax,%ecx
40000e43:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e47:	09 f9                	or     %edi,%ecx
40000e49:	89 df                	mov    %ebx,%edi
40000e4b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e4f:	89 c1                	mov    %eax,%ecx
40000e51:	d3 e5                	shl    %cl,%ebp
40000e53:	89 d1                	mov    %edx,%ecx
40000e55:	d3 ef                	shr    %cl,%edi
40000e57:	89 c1                	mov    %eax,%ecx
40000e59:	89 f0                	mov    %esi,%eax
40000e5b:	d3 e3                	shl    %cl,%ebx
40000e5d:	89 d1                	mov    %edx,%ecx
40000e5f:	89 fa                	mov    %edi,%edx
40000e61:	d3 e8                	shr    %cl,%eax
40000e63:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000e68:	09 d8                	or     %ebx,%eax
40000e6a:	f7 74 24 08          	divl   0x8(%esp)
40000e6e:	89 d3                	mov    %edx,%ebx
40000e70:	d3 e6                	shl    %cl,%esi
40000e72:	f7 e5                	mul    %ebp
40000e74:	89 c7                	mov    %eax,%edi
40000e76:	89 d1                	mov    %edx,%ecx
40000e78:	39 d3                	cmp    %edx,%ebx
40000e7a:	72 06                	jb     40000e82 <__umoddi3+0xe2>
40000e7c:	75 0e                	jne    40000e8c <__umoddi3+0xec>
40000e7e:	39 c6                	cmp    %eax,%esi
40000e80:	73 0a                	jae    40000e8c <__umoddi3+0xec>
40000e82:	29 e8                	sub    %ebp,%eax
40000e84:	1b 54 24 08          	sbb    0x8(%esp),%edx
40000e88:	89 d1                	mov    %edx,%ecx
40000e8a:	89 c7                	mov    %eax,%edi
40000e8c:	89 f5                	mov    %esi,%ebp
40000e8e:	8b 74 24 04          	mov    0x4(%esp),%esi
40000e92:	29 fd                	sub    %edi,%ebp
40000e94:	19 cb                	sbb    %ecx,%ebx
40000e96:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
40000e9b:	89 d8                	mov    %ebx,%eax
40000e9d:	d3 e0                	shl    %cl,%eax
40000e9f:	89 f1                	mov    %esi,%ecx
40000ea1:	d3 ed                	shr    %cl,%ebp
40000ea3:	d3 eb                	shr    %cl,%ebx
40000ea5:	09 e8                	or     %ebp,%eax
40000ea7:	89 da                	mov    %ebx,%edx
40000ea9:	83 c4 1c             	add    $0x1c,%esp
40000eac:	5b                   	pop    %ebx
40000ead:	5e                   	pop    %esi
40000eae:	5f                   	pop    %edi
40000eaf:	5d                   	pop    %ebp
